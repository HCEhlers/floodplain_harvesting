...
3. notebooks <- our Jupyter Notebook for the model
4. raw_image_data <- all our data files. Note: the name for each image are longitude and latitude coordinates, feel free to copy-paste these coordinates to find the actual locations. You can find the locations using MAXAR discover: https://discover.maxar.com/
5. scripts <- here you will find "split_data.py" copy-paste the code and run it on NVIDIA Jetson Nano.
